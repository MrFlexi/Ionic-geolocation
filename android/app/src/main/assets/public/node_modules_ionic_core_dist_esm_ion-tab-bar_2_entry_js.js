(self["webpackChunkcoordinates"] = self["webpackChunkcoordinates"] || []).push([["node_modules_ionic_core_dist_esm_ion-tab-bar_2_entry_js"],{
...
const TabBar = class {
  constructor(hostRef) {
    ...
    this.ionTabBarChanged = (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionTabBarChanged", 7);
  ...
  render() {
    ...
    return ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, { role: "tablist", "aria-hidden": keyboardVisible ? 'true' : null, class: (0,_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_2__.c)(color, {
        [mode]: true,
...
const TabButton = class {
  constructor(hostRef) {
    (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.r)(this, hostRef);
    this.ionTabButtonClick = (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionTabButtonClick", 7);
    /**
  ...
  render() {
    ...
    return ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, { onClick: this.onClick, onKeyup: this.onKeyUp, role: "tab", tabindex: tabIndex, "aria-selected": selected ? 'true' : null, id: tab !== undefined ? `tab-button-${tab}` : null, class: {
        [mode]: true,
...
//# sourceMappingURL=node_modules_ionic_core_dist_esm_ion-tab-bar_2_entry_js.js.map