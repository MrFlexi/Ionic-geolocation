(self["webpackChunkcoordinates"] = self["webpackChunkcoordinates"] || []).push([["node_modules_ionic_core_dist_esm_ion-segment_2_entry_js"],{
...
const Segment = class {
  constructor(hostRef) {
    ...
    this.ionSelect = (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionSelect", 7);
   ...
   */
  addRipple(detail) {
    const useRippleEffect = _ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('animated', true) && _ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('rippleEffect', true);
    if (!useRippleEffect) {
      return;
    }
    const buttons = this.getButtons();
    ...
    const { x, y } = (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.p)(detail.event);
  ...
  render() {
    ...
    return ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, { role: "tablist", onClick: this.onClick, class: (0,_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_3__.c)(this.color, {
        [mode]: true,
...
const SegmentButton = class {
  ...
  connectedCallback() {
    ...
    if (segmentEl) {
      this.updateState();
      (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.a)(segmentEl, 'ionSelect', this.updateState);
      (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.a)(segmentEl, 'ionStyle', this.updateStyle);
    }
  }
  disconnectedCallback() {
    const segmentEl = this.segmentEl;
    if (segmentEl) {
      (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.b)(segmentEl, 'ionSelect', this.updateState);
      (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.b)(segmentEl, 'ionStyle', this.updateStyle);
      this.segmentEl = null;
    }
  }
  get hasLabel() {
  ...
  render() {
    ...
    return ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, { role: "tab", "aria-selected": checked ? 'true' : 'false', "aria-disabled": disabled ? 'true' : null, tabIndex: tabIndex, class: {
        [mode]: true,
        'in-toolbar': (0,_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_3__.h)('ion-toolbar', this.el),
        'in-toolbar-color': (0,_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_3__.h)('ion-toolbar[color]', this.el),
