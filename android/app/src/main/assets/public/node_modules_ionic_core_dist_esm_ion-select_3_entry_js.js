(self["webpackChunkcoordinates"] = self["webpackChunkcoordinates"] || []).push([["node_modules_ionic_core_dist_esm_ion-select_3_entry_js"],{
...
/* harmony import */ var _hardware_back_button_4a6b37fb_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./hardware-back-button-4a6b37fb.js */ 3087);
...
const Select = class {
  ...
  async openPopover(ev) {
    ...
    return _overlays_e9ccff30_js__WEBPACK_IMPORTED_MODULE_3__.c.create(popoverOpts);
  }
  async openActionSheet() {
    const mode = (0,_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.b)(this);
    const interfaceOptions = this.interfaceOptions;
    const actionSheetOpts = Object.assign(Object.assign({ mode }, interfaceOptions), { buttons: this.createActionSheetButtons(this.childOpts, this.value), cssClass: ['select-action-sheet', interfaceOptions.cssClass] });
    return _overlays_e9ccff30_js__WEBPACK_IMPORTED_MODULE_3__.b.create(actionSheetOpts);
  }
  async openAlert() {
    ...
    return _overlays_e9ccff30_js__WEBPACK_IMPORTED_MODULE_3__.a.create(alertOpts);
  }
  /**
  ...
  getLabel() {
    return (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.el);
  }
  hasValue() {
    return this.getText() !== '';
  }
  ...
  render() {
    ...
    const mode = (0,_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.b)(this);
    const { labelText, labelId } = (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.d)(el, inputId);
    (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.e)(true, el, name, parseValue(value), disabled);
    ...
    const displayLabel = labelText !== undefined
      ...
      : selectText;
    return ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, { onClick: this.onClick, role: "button", "aria-haspopup": "listbox", "aria-disabled": disabled ? 'true' : null, "aria-label": displayLabel, class: {
        [mode]: true,
        'in-item': (0,_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_4__.h)('ion-item', el),
        'select-disabled': disabled,
        'select-expanded': isExpanded
      } }, (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { "aria-hidden": "true", class: selectTextClasses, part: textPart }, selectText), (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "select-icon", role: "presentation", part: "icon" }, (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "select-icon-inner" })), (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", { id: labelId }, displayLabel), (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "button", disabled: disabled, id: inputId, "aria-labelledby": labelId, "aria-haspopup": "listbox", "aria-expanded": `${isExpanded}`, onFocus: this.onFocus, onBlur: this.onBlur, ref: (focusEl => this.focusEl = focusEl) })));
  }
...
const SelectOption = class {
  ...
  render() {
    return ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, { role: "option", id: this.inputId, class: (0,_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.b)(this) }));
  }
  get el() { return (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.i)(this); }
};
...
const SelectPopover = class {
  ...
  onSelect(ev) {
    ...
    if (option) {
      (0,_overlays_e9ccff30_js__WEBPACK_IMPORTED_MODULE_3__.s)(option.handler);
    }
  }
  render() {
    const checkedOption = this.options.find(o => o.checked);
    const checkedValue = checkedOption ? checkedOption.value : undefined;
    return ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, { class: (0,_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.b)(this) }, (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-list", null, this.header !== undefined && (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-list-header", null, this.header), (this.subHeader !== undefined || this.message !== undefined) &&
      (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-item", null, (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-label", { class: "ion-text-wrap" }, this.subHeader !== undefined && (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("h3", null, this.subHeader), this.message !== undefined && (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, this.message))), (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-radio-group", { value: checkedValue }, this.options.map(option => (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-item", { class: (0,_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_4__.g)(option.cssClass) }, (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-label", null, option.text), (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-radio", { value: option.value, disabled: option.disabled })))))));
  }
};
