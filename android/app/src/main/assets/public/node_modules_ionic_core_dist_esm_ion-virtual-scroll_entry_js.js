(self["webpackChunkcoordinates"] = self["webpackChunkcoordinates"] || []).push([["node_modules_ionic_core_dist_esm_ion-virtual-scroll_entry_js"],{
...
const VirtualScroll = class {
  ...
  updateVirtualScroll() {
    ...
    (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.f)(this.readVS.bind(this));
    (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.c)(this.writeVS.bind(this));
  }
  readVS() {
  ...
  updateCellHeight(cell, node) {
    ...
    if (node) {
      (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_1__.c)(node, update);
    }
    else {
      update();
    }
  ...
  render() {
    return ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, { style: {
      ...
      } }, this.renderItem && ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(VirtualProxy, { dom: this.virtualDom }, this.virtualDom.map(node => this.renderVirtualNode(node))))));
  }
