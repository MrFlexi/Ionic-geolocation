(self["webpackChunkcoordinates"] = self["webpackChunkcoordinates"] || []).push([["node_modules_ionic_core_dist_esm_ion-spinner_entry_js"],{
...
/* harmony import */ var _spinner_configs_cd7845af_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./spinner-configs-cd7845af.js */ 408);
...
const Spinner = class {
  ...
  render() {
    const self = this;
    const mode = (0,_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.b)(self);
    ...
    return ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, { class: (0,_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_2__.c)(self.color, {
        [mode]: true,
...
const buildCircle = (spinner, duration, index, total) => {
  ...
  return ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("svg", { viewBox: data.viewBox || '0 0 64 64', style: data.style }, (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("circle", { transform: data.transform || 'translate(32,32)', cx: data.cx, cy: data.cy, r: data.r, style: spinner.elmDuration ? { animationDuration: duration + 'ms' } : {} })));
};
const buildLine = (spinner, duration, index, total) => {
  const data = spinner.fn(duration, index, total);
  data.style['animation-duration'] = duration + 'ms';
  return ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("svg", { viewBox: data.viewBox || '0 0 64 64', style: data.style }, (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("line", { transform: "translate(32,32)", y1: data.y1, y2: data.y2 })));
};
