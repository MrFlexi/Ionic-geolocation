(self["webpackChunkcoordinates"] = self["webpackChunkcoordinates"] || []).push([["node_modules_ionic_core_dist_esm_ion-toggle_entry_js"],{
...
/* harmony import */ var _haptic_27b3f981_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./haptic-27b3f981.js */ 2954);
...
const Toggle = class {
  ...
  onMove(detail) {
    if (shouldToggle(document, this.checked, detail.deltaX, -10)) {
      this.checked = !this.checked;
      (0,_haptic_27b3f981_js__WEBPACK_IMPORTED_MODULE_3__.c)();
    }
  }
  onEnd(ev) {
    this.activated = false;
  ...
  render() {
    ...
    const { label, labelId, labelText } = (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.d)(el, inputId);
    const value = this.getValue();
    (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.e)(true, el, name, (checked ? value : ''), disabled);
    return ((0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, { onClick: this.onClick, "aria-labelledby": label ? labelId : null, "aria-checked": `${checked}`, "aria-hidden": disabled ? 'true' : null, role: "switch", class: (0,_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_4__.c)(color, {
        [mode]: true,
...
//# sourceMappingURL=node_modules_ionic_core_dist_esm_ion-toggle_entry_js.js.map