(self["webpackChunkcoordinates"] = self["webpackChunkcoordinates"] || []).push([["node_modules_ionic_core_dist_esm_ion-radio_2_entry_js"],{
...
const Radio = class {
  ...
  connectedCallback() {
    ...
    if (radioGroup) {
      this.updateState();
      (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.a)(radioGroup, 'ionChange', this.updateState);
    }
  }
  disconnectedCallback() {
    const radioGroup = this.radioGroup;
    if (radioGroup) {
      (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.b)(radioGroup, 'ionChange', this.updateState);
      this.radioGroup = null;
    }
  }
  componentWillLoad() {
