(self["webpackChunkcoordinates"] = self["webpackChunkcoordinates"] || []).push([["node_modules_ionic_core_dist_esm_ion-modal_entry_js"],{
...
/* harmony import */ var _cubic_bezier_eea9a7a9_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./cubic-bezier-eea9a7a9.js */ 7807);
/* harmony import */ var _index_34cb2743_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./index-34cb2743.js */ 9461);
/* harmony import */ var _helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./helpers-dd7e4b7b.js */ 2377);
...
const createSwipeToCloseGesture = (el, animation, onDismiss) => {
  ...
  const onMove = (detail) => {
    const step = (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_9__.j)(0.0001, detail.deltaY / height, 0.9999);
  ...
  const onEnd = (detail) => {
    ...
    if (!shouldComplete) {
      ...
      newStepValue += (0,_cubic_bezier_eea9a7a9_js__WEBPACK_IMPORTED_MODULE_7__.g)([0, 0], [1, 0], [0.68, 0.28], [1, 1], step)[0];
    }
    else {
      animation.easing('cubic-bezier(0.32, 0.72, 0, 1)');
      newStepValue += (0,_cubic_bezier_eea9a7a9_js__WEBPACK_IMPORTED_MODULE_7__.g)([0, 0], [0.32, 0.72], [0, 1], [1, 1], step)[0];
    }
  ...
  const gesture = (0,_index_34cb2743_js__WEBPACK_IMPORTED_MODULE_8__.createGesture)({
    el,
...
const computeDuration = (remaining, velocity) => {
  return (0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_9__.j)(400, remaining / Math.abs(velocity * 1.1), 500);
};
...
const iosEnterAnimation = (baseEl, presentingEl) => {
  ...
  if (presentingEl) {
    ...
    const presentingAnimation = (0,_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_6__.c)()
      .beforeStyles({
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_6__.c)()
          .afterStyles({
          'transform': finalTransform
        })
...
const Modal = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionModalDidPresent", 7);
    this.willPresent = (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionModalWillPresent", 7);
    this.willDismiss = (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionModalWillDismiss", 7);
    this.didDismiss = (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionModalDidDismiss", 7);
  ...
  async present() {
    ...
    this.usersElement = await (0,_framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.delegate, container, this.component, ['ion-page'], componentProps);
    await (0,_index_931440b1_js__WEBPACK_IMPORTED_MODULE_5__.e)(this.usersElement);
    (0,_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.c)(() => this.el.classList.add('show-modal'));
    await (0,_overlays_e9ccff30_js__WEBPACK_IMPORTED_MODULE_3__.d)(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, this.presentingElement);
  ...
  async dismiss(data, role) {
    ...
    const enteringAnimation = _overlays_e9ccff30_js__WEBPACK_IMPORTED_MODULE_3__.h.get(this) || [];
    const dismissed = await (0,_overlays_e9ccff30_js__WEBPACK_IMPORTED_MODULE_3__.f)(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, this.presentingElement);
    if (dismissed) {
