(self["webpackChunkcoordinates"] = self["webpackChunkcoordinates"] || []).push([["node_modules_ionic_core_dist_esm_ion-button_2_entry_js"],{
...
const Button = class {
  constructor(hostRef) {
    ...
    this.handleClick = (ev) => {
      ...
      else if ((0,_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__.k)(this.el)) {
